...
namespace RQAT
{
    ...
    public class DeadCodeDetectionPlugin : IAssemblyPlugin
    {
        #region Fields
        ...
        /// Default constructor.
        /// </summary>
        public DeadCodeDetectionPlugin()
        {
            //
        }
        ...
        /// The description.
        /// </value>
        public string Description => "This plugin decompiles an Assembly and reports Dead Code.";
